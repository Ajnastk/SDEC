...
import SpotlightCard from "@/public/assets/animations/SpotlightCard";
import Magnet from "@/public/assets/animations/Magnet";
        ...
        <div className="relative w-full md:w-3/7 flex flex-col justify-center ">
          <div className="md:flex justify-center items-center w-full hidden ">
            <div className="flex flex-col gap-20 ">
              {Object.values(feature.iconsImageArray).map((icon, index) => (
                <Magnet
                  key={index}
                  padding={50}
                  disabled={false}
