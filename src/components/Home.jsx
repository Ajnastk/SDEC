  ...
  return (
    <div className=" bg-[#010a23] bg-[url(/images/home-bg.png)]">
      ...
      <div className="flex">
        ...
        <img className=' m-15 mx-50 w-[150px] h-[50px] lg:w-[278px] lg:h-[92px]' src="/images/cloud1.png"/>
        <div className="flex flex-col">
        ...
        <p className=" text-white mt-5">
          ...
          <div className="lg:mt-15 lg:-mx-10">
            <img className="w-[150px] h-[50px] lg:w-[278px] lg:h-[92px]" src="/images/cloud1.png" />
          </div>
        ...
        <div>
          <img className="lg:w-[718px] lg:h-[686px]" src="images/person.png"/>
        </div>
      </div>
    </div> 
  )
